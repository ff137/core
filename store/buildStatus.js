...
import { getRedisCountDay, getRedisCountHour } from "../util/utility";
  ...
  series(
    {
      ...
      cassandra_repair_last_day(cb) {
        getRedisCountDay(redis, "cassandra_repair", cb);
      },
      ...
      webhooks_last_day(cb) {
        getRedisCountDay(redis, "webhook", cb);
      },
      feed_last_day(cb) {
        getRedisCountDay(redis, "feed", cb);
      },
