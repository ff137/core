...
const defaults = {
  ...
  API_FREE_LIMIT: "3000", // number of api requests per day before 429 is returned. If using an API key, calls over this are charged.
  ...
  GOOGLE_CLOUD_RETRIEVER_TEMPLATE: "", // Template name of the retriever instance
  ...
  HEALTH_TIMEOUT: "7200", // Number of seconds before a process is considered unhealthy
};
